package io.github.honatsugiexpress.canvasegg.svgz.compressor.ui.debug

import androidx.compose.runtime.Composable
import androidx.compose.runtime.CompositionLocalProvider
import androidx.compose.ui.tooling.preview.Devices
import androidx.compose.ui.tooling.preview.Preview
import io.github.honatsugiexpress.canvasegg.svgz.compressor.ui.nav.NavInit
...
internal val InteropResourcesReader = object : ResourceReader {
    override fun getUri(path: String): String {
        val homeDir = System.getProperty("user.home")?.let {
            File(it)
        } ?: return ""
        val resFile =
            homeDir
